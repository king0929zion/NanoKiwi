        ...
        {bookmarks.map(bookmark => (
          <div
            ...
            className={`group relative rounded-lg p-3 ${
              isDarkMode ? 'bg-[#2A2A2A] hover:bg-[#404040]' : 'bg-white hover:bg-[#F5F5F0]'
            } border ${isDarkMode ? 'border-[#404040]' : 'border-[#E5E5E0]'}`}>
              ...
              <div className="flex items-center">
                <input
                  ...
                  className={`mr-2 grow rounded px-2 py-1 text-sm ${
                    isDarkMode ? 'border-[#404040] bg-[#2A2A2A] text-gray-200' : 'border-[#E5E5E0] bg-white text-gray-700'
                  } border`}
                />
                <button
              ...
              <>
                ...
                <button
                  ...
                  className={`absolute right-[28px] top-1/2 z-10 -translate-y-1/2 rounded p-1 opacity-0 transition-opacity duration-200 group-hover:opacity-100 ${
                    isDarkMode
                      ? 'bg-[#2A2A2A] text-[#D97706] hover:bg-[#404040]'
                      : 'bg-white text-[#F59E0B] hover:bg-[#F5F5F0]'
                  }`}
