...
export default function ChatInput({
  ...
  return (
    <form
      ...
      className={`overflow-hidden rounded-lg border transition-colors ${disabled ? 'cursor-not-allowed' : isDarkMode ? 'focus-within:border-[#D97706] hover:border-[#D97706]' : 'focus-within:border-[#F59E0B] hover:border-[#F59E0B]'} ${isDarkMode ? 'border-[#404040]' : 'border-[#E5E5E0]'}`}
      ...
      <div className="flex flex-col">
        ...
        {attachedFiles.length > 0 && (
          <div
            className={`flex flex-wrap gap-2 border-b p-2 ${
              isDarkMode ? 'border-[#404040] bg-[#2A2A2A]' : 'border-[#E5E5E0] bg-[#F5F5F0]'
            }`}>
            {attachedFiles.map((file, index) => (
              <div
                key={index}
                className={`flex items-center gap-1 rounded-md px-2 py-1 text-xs ${
                  isDarkMode ? 'bg-[#404040] text-gray-300' : 'bg-gray-200 text-gray-700'
                }`}>
                ...
                <button
                  ...
                  className={`ml-1 rounded-sm transition-colors ${
                    isDarkMode ? 'hover:bg-[#525252]' : 'hover:bg-gray-300'
                  }`}
        ...
        <div
          className={`flex items-center justify-between px-2 py-1.5 ${
            disabled ? (isDarkMode ? 'bg-[#2A2A2A]' : 'bg-gray-100') : isDarkMode ? 'bg-[#2A2A2A]' : 'bg-white'
          }`}>
            ...
            <button
              ...
              className={`rounded-md p-1.5 transition-colors ${
                disabled
                  ...
                  : isDarkMode
                    ? 'text-gray-400 hover:bg-[#404040] hover:text-gray-200'
